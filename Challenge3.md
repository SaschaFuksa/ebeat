...
LSTM-Layer sind rekurrente neuronale Netze, die eine Sequenz als Input annehmen und entweder Sequenzen (return_sequences=True) oder eine Matrix zurückgeben können. ( siehe Beschreibung 2. LSTM) 
