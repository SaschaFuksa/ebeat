...
class MusicSampleDecoderModel:
    ...
    def get_decoder_data(self, encoder_states):
        decoder_inputs = Input(shape=(None, self.num_decoder_tokens))
        self.decoder_lstm = LSTM(MusicSampleConfiguration.latent_dim, return_sequences=True, return_state=True)
    ...
    def build_decoder_model(self, decoder_inputs):
        decoder_state_input_h = Input(shape=(MusicSampleConfiguration.latent_dim,))
        decoder_state_input_c = Input(shape=(MusicSampleConfiguration.latent_dim,))
