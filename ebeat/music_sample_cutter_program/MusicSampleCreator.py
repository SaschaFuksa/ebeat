...
class MusicSampleCreator:
    ...
    def __init__(self, input_directory: str, output_directory: str, song_length: int, amount_of_samples: int):
    ...
    def create_samples(self):
        ...
        if self.song_length > 0:
            self.music_sample_cutter = EqualMusicSampleCutter
        else:
        ...
        for song in songs:
            ...
            sample_saver = SampleSaver(self.output_directory, "", "", 0)
